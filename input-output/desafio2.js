...
let profissao = ("Qual é a sua profissão?");
let cidade = ("Em qual cidade você mora?");
let gostaJS = ("Você gosta de JavaScript? (sim/não)").toLowerCase() === "sim";
let comidasFavoritas = ("Liste suas comidas favoritas separadas por vírgula").split(",");
let pessoaNome = ("Nome de uma pessoa com quem você mora:");
let pessoaIdade = (("Idade dessa pessoa:"));
let pessoaComQuemMora = { nome: pessoaNome, idade: pessoaIdade };
